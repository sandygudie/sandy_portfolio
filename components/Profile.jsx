    ...
    <>
      <div className="bg-[#6d3d22] lg:h-screen text-white">
        <div className="w-10/12 py-12 lg:py-0 lg:w-10/12 max-w-10/12 mx-auto h-full flex flex-col-reverse lg:flex-row items-center justify-center lg:justify-between">
          <div data-aos="zoom-out"  data-aos-duration="800"  className="font-semibold lg:text-left text-center">
            ...
            <div className="mx-auto lg:mr-auto lg:ml-0 mt-16 w-64">
              <a
          ...
          <div>
            {" "}
            <div data-aos="zoom-out"  data-aos-duration="800" className="bg-white p-5 rounded-2xl">
              <img
