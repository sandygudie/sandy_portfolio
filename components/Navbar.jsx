  ...
  return (
    <div className="w-full px-6 md:px-12 z-40 bg-black fixed top-0">
      <div className="w-full flex justify-between py-6 gap-2 items-center">
        ...
        <a
          className="w-20 md:w-36 text-xs md:text-base block text-center p-2 md:p-3 border-gray-100 border bg-white text-dark hover:bg-transparent hover:text-white"
