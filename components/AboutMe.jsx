  ...
  return (
    <section id="aboutme" className="pt-36 px-6 md:px-12">
      ...
      <div className="lg:pl-32 lg:pr-8 text-gray-100 !text-[1.2rem] md:!text-[23px] !leading-[3.5rem]">
        <p className="">
          I am a software developer with expertise in building innovative and scalable enterprise applications. I help organizations achieve their goals through efficient, and user-focused software solutions.
        </p>

        <p className="">
          I advocate for open source technology because it benefits everyone and drives inclusive innovation.
          <br></br>
          I am currently working on advancing Africa’s digital future through technology, policy, and open collaboration, with focus on impactful public sector innovation.
          <br></br>
